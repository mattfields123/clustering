...
contains
    function passive(partx, party, t, phase1, phase2, time1, time2, dt, amplitudes, dispersions) result(parts)
        ...
        parts = (/partx,party/)
        k1 = velocity_pointML(partx,party,t,phase1,phase2,time1,time2,amplitudes, dispersions)
        k2 = velocity_pointML(partx+k1(1)*dt/2,party+k1(2)*dt/2,t+dt/2,phase1,phase2,time1,time2,amplitudes,dispersions)
   ...
   function passive2(partx, party, t, phase1, phase2, time1, time2, dt, amplitudes, dispersions, g) result(parts)
        real(dp) :: g
        real(dp) :: partx, party, t, phase1(65,65), phase2(65,65), time1(65,65), time2(65,65), parts(2)
        real(dp) :: amplitudes(65,65), dispersions(65,65)
        real(dp) :: k1(2), k2(2), k3(2), k4(2)
