...
function vel_passive(timesteps, phase1, phase2, time1, time2, N_part)
...
function vel_passive2(timesteps, phase1, phase2, time1, time2, N_part, g) result(partavg)
...
real(dp) :: x, y, t, phase1(65,65), phase2(65,65), time1(65,65), time2(65,65), velocity(2), parts(2)
    ...
    partavg(1) = sum(partx_array)/(N_part**2)
    ...
    do c_n2x = 1, N_part
        do c_n2y = 1, N_part
            ...
            parts = passive2(partx_array(c_n2x,c_n2y),party_array(c_n2x,c_n2y),t,phase1,phase2,time1,time2,dt,amplitudes,dispersions,g)
            partx_array(c_n2x,c_n2y) = parts(1)
            party_array(c_n2x,c_n2y) = parts(2)
    ...
    !$OMP END PARALLEL DO 
    partavg(counter_t+1) = sum(partx_array)/(N_part**2)
